...
function Chart() {
    ...
    return (
        <React.Fragment>
                    ...
                    <h4 className="text-center">CROSSDOCK</h4>
                   
                    <div className="row mt-4">
                        <div className="col-12 col-lg-6 mb-4">
                            <div className="card border-0 overflow-hidden">
                                <div className="card-body p-0 d-flex align-items-center">
                                    <Link to="/ilslate" className="d-flex align-items-center" style={{ textDecoration: 'none', color: 'inherit' }}>
                        ...
                        <div className="col-12 col-lg-6 mb-4">
                            <div className="card border-0   overflow-hidden ">
                                <div className="card-body p-0 d-flex align-items-center">
                                    <Link to="/ilsunlate" className="d-flex align-items-center" style={{ textDecoration: 'none', color: 'inherit' }}>
                    ...
                    <div className="col-12 mb-2">
                        <div className="card-total">
                           <div className="text-center">
                              <Link to="/ilssps" className="d-flex align-items-center total-link">
                            <div>
