...
function ChartRps() {
    ...
    const fetchData = async () => {
        try {
            const response = await Api.get('api/chartreplenishment');
    ...
    const handleClick = (entry) => {
        if (entry.name === 'Lates') {
            navigate('/replenishmentlate');
        } else if (entry.name === 'On Times') {
            navigate('/replenishmentunlate');
        }
    };
    ...
    return (
        <React.Fragment>
                    ...
                    <h4 className="text-center">REPLENISHMENT</h4>
                   
                    <div className="row mt-4">
                        <div className="col-12 col-lg-6 mb-4">
                            <div className="card border-0 overflow-hidden">
                                <div className="card-body p-0 d-flex align-items-center">
                                    <Link to="/replenishmentlate" className="d-flex align-items-center" style={{ textDecoration: 'none'}}>
                        ...
                        <div className="col-12 col-lg-6 mb-4">
                            <div className="card border-0   overflow-hidden ">
                                <div className="card-body p-0 d-flex align-items-center">
                                    <Link to="/replenishmentunlate" className="d-flex align-items-center" style={{ textDecoration: 'none', color: 'inherit' }}>
                    ...
                    <div className="col-12 mb-2">
                        <div className="card-total">
                           <div className="text-center">
                              <Link to="/replenishment" className="d-flex align-items-center total-link">
                            <div>
