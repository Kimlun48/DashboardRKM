...
function ChartCps() {
    ...
    const fetchData = async () => {
        try {
            const response = await Api.get('api/chartacs');
    ...
    const handleClick = (entry) => {
        if (entry.name === 'Lates') {
            navigate('/cashstoragelate');
        } else if (entry.name === 'On Times') {
            navigate('/cashstorageunlate');
        }
    };
    ...
    return (
        <React.Fragment>
                    ...
                    <h4 className="text-center">CASH</h4>
                   
                    <div className="row mt-4">
                        <div className="col-12 col-lg-6 mb-4">
                            <div className="card border-0 overflow-hidden">
                                <div className="card-body p-0 d-flex align-items-center">
                                    <Link to="/cashstoragelate" className="d-flex align-items-center" style={{ textDecoration: 'none'}}>
                        ...
                        <div className="col-12 col-lg-6 mb-4">
                            <div className="card border-0   overflow-hidden ">
                                <div className="card-body p-0 d-flex align-items-center">
                                    <Link to="/cashstorageunlate" className="d-flex align-items-center" style={{ textDecoration: 'none', color: 'inherit' }}>
                    ...
                    <div className="col-12 mb-2">
                        <div className="card-total">
                           <div className="text-center">
                              <Link to="/cashstorage" className="d-flex align-items-center total-link">
                            <div>
