...
function ReplenishmentUnLate() {
    document.title = "replenishmentunlate";
    ...
    const fetchData = async () => {
        try {
            const response = await Api.get('api/replenishmentunlate');
                        ...
                        <div className="col-md-12">
                            <div className="card border-0 rounded shadow-sm border-top-success">
                                <div className="card-header">
                                    <span className='font-weight-bold'><i className='fa fa-folder'></i> REPLENISHMENT ON TIMES</span>
                                </div>
...
export default ReplenishmentUnLate;
