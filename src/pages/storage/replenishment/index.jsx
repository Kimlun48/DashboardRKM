...
function ReplenishmentIndex() {
    ...
    const fetchData = async () => {
        try {
            const response = await Api.get('api/replenishment');
                        ...
                        <div className="col-md-12">
                            <div className="card border-0 rounded shadow-sm border-top-success">
                                <div className="card-header">
                                    <span className='font-weight-bold'><i className='fa fa-folder'></i> REPLENISHMENT ALL</span>
                                </div>
...
export default ReplenishmentIndex;
