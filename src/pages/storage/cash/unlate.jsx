...
function CashStorageUnLate() {
    document.title = "AR CASH ONTIME";
    ...
    const fetchData = async () => {
        try {
            const response = await Api.get('api/alertcasstorageunlate');
                        ...
                        <div className="col-md-12">
                            <div className="card border-0 rounded shadow-sm border-top-success">
                                <div className="card-header">
                                    <span className='font-weight-bold'><i className='fa fa-folder'></i> AR CASH ONTIME</span>
                                </div>
...
export default CashStorageUnLate;
