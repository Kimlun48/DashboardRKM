...
function CashStorageIndex() {
    document.title = "AR CASH ALL";
    ...
    const fetchData = async () => {
        try {
            const response = await Api.get('api/alertcasstorage');
                        ...
                        <div className="col-md-12">
                            <div className="card border-0 rounded shadow-sm border-top-success">
                                <div className="card-header">
                                    <span className='font-weight-bold'><i className='fa fa-folder'></i> AR CASH ALL</span>
                                </div>
...
export default CashStorageIndex;
