...
function PutAwayUnlate() {

    document.title = "RECEIPT ONTIME";
...
const fetchData = async () => {
    try {
        const response = await Api.get('api/paunlate');
...
const columns = [
    ...
    { name: 'No Container', selector: row => row.CONTAINER_ID, sortable: true , width:'100px'},
                    ...
                    <div className="col-md-12">
                        <div className="card border-0 rounded shadow-sm border-top-success">
                            <div className="card-header">
                                <span className='font-weight-bold'><i className='fa fa-folder'></i> RECEIPT ON TIMES</span>
                            </div>
